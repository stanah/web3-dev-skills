...
## ガイドライン
- 生成コードは常に`rules/base-rules.md`を満たし、EthTrust Security Levels v3・OWASP SCSTG・Solidity公式Introductionで定義される言語仕様観点を満たすこと
...
- 言語仕様や低レベル挙動に関する質問には`docs/solidity-intro-crossref.md`を参照して答えを補強する
